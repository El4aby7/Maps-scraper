            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-surface-variant/30">
                {results.length === 0 && !isScraping ? (
                  <tr>
                    <td colSpan={4} className="px-6 py-10 text-center text-on-surface-variant font-semibold">
                      No results found yet. Start an extraction from the Dashboard.
                    </td>
                  </tr>
                ) : isScraping && results.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="px-6 py-10 text-center text-on-surface-variant font-semibold animate-pulse">
                      Extracting data...
                    </td>
                  </tr>
                ) : (
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="relative h-48 w-full bg-slate-200">
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-black/80 to-transparent">
                  <h2 className="text-2xl font-extrabold text-white tracking-tight">{selectedResult.name}</h2>
                  <p className="text-white/70 text-sm mt-1">{selectedResult.category}</p>
                </div>
              </div>
